...
%>
		<tr bgcolor="#FFFFFF">
			...
			<td><input type="submit" value="Edit" formaction="EditCourse.jsp?courseid=<%=resultSet.getString("courseid")%>"/></td>
			<td><input type="submit" value="Delete" formaction="DeleteCourse?courseid=<%=resultSet.getString("courseid")%>"/></td>	
		</tr>
<%}
statement.close();
con.close();
