...
public class LoginControllerAdmin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("login")!=null) 
        {
            ...
            LoginAdmin login=new LoginAdmin(); //this class contain main logic to perform function calling and database operation
            ...
            if(authorize==true) //check calling authorizeLogin() function receive string "SUCCESS LOGIN" message after continue process
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("Admin_Main.jsp"); //redirect to welcome.jsp page
